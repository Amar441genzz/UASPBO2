...
public class cruddb {
    ...
    private String jdbcURL = "jdbc:mysql://localhost:3306/2210010093_periklanan";
    ...
    public void SimpanDinamis(String NamaTabel, String[] Fieldnya, String[] Isinya) {
        try {
            ...
            for (int i = 0; i < Fieldnya.length; i++) {
                if (Fieldnya[i].equals("KodeDVD")) {
                    kodeDVDIndex = i;
                    break;
                }
            }

            if (kodeDVDIndex != -1 && Isinya[kodeDVDIndex].length() > 5) { // Sesuaikan dengan panjang yang dibutuhkan
                JOptionPane.showMessageDialog(null, "Data KodeDVD terlalu panjang. Maksimum 5 karakter.");
                return;
            }
